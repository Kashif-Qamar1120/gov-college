				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2> Edit courses<small>Record</small></h2>

									<div class="clearfix"></div>
								</div>

								<br />
								<form id="demo-form2" action="process/courses_update.php" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
								<div class="form-group">
                        <label for="recipient-name" class="col-form-label">course Name:</label>
                        <input type="text" class="form-control" name="name" value="<?php echo $fetch['c_name'] ?>">
                    </div>
                    <div class="form-group">
						...
						<input type="hidden" name="newphotos[]" multiple value="<?php echo $fetch['picture']; ?>" class="form-control col-md-7 col-xs-12">
									...
									<div class="form-group" align="center">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											...
											<input type="hidden" name="id" value="<?php echo $fetch['c_id']; ?>">
