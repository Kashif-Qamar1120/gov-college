...
if (isset($_GET['edit']) && $_GET['edit'] != '') {
	...
	inner join pictures p on events.id = p.event_id where id = '$edit'");
				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<h2> Edit Service<small>Record</small></h2>

									<div class="clearfix"></div>
								</div>

								<br />
								<form id="demo-form2" action="process/event_update.php" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
