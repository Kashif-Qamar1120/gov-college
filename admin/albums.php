            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Albums <small>Record</small></h3>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
							<a href="edit_albums.php?edit=<?php echo $record['id']; ?>">
                          ...
                          <a href="process/album_delete.php?dlt=<?php echo $record['id']; ?>">
    ...
    <div class="modal-content">
      ...
      <?php
                    ...
                    while ($image_row = mysqli_fetch_assoc($image_result)) {
                        ...
                        ?>
                        <form action="process/album_imageUpdate.php" method="post" enctype="multipart/form-data">
                            <img src="uploads/albums/<?php echo $image_path; ?>" width="100" height="100">
                            ...
                            <!-- <a href="process/album_imageUpdate.php?dlt=<?php echo $image_row['picture_id']; ?>"><button class="btn btn-danger">Delete</button></a> -->
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="process/album_process.php" method="post" enctype="multipart/form-data">
