            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Staff <small>Record</small></h3>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <!-- <a href="offer.php"><button class="btn btn-success btn-sm">Ad sales</button></a> -->
                                ...
                                <a href="process/staff_delete.php?all"> <button class="btn btn-danger btn-lg" style="float: right">Delete All</button></a>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
    ...
    <div class="modal-content">
      ...
      <?php
                    ...
                    while ($image_row = mysqli_fetch_assoc($image_result)) {
                        ...
                        ?>
                        <form action="process/staff_imageUpdate.php" method="post" enctype="multipart/form-data">
                            <img src="uploads/staff/<?php echo $image_path; ?>" width="100" height="100">
                            <input type="file" name="newimg" class="form-control">
                            <input type="hidden" name="imgid" value="<?php echo $image_row['s_id']; ?>"  class="form-control">
                            <input type="hidden" name="id" value="<?php echo $record['s_id']; ?>"  class="form-control">
                            <input type="submit" value="update" class="btn btn-info">
                            <!-- <a href="process/album_imageUpdate.php?dlt=<?php echo $image_row['s_id']; ?>"><button class="btn btn-danger">Delete</button></a> -->
