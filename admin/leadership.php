...
$query = "select * from leadership_profiles";
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>LeaderShip<small>Record</small></h3>
                        </div>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <td><button data-toggle="modal" data-target="#imageModal<?php echo $record['lp_id']; ?>">View Images</button></td>
										<td><?php echo $record['description']; ?></td>

                                        <td class="text-right">
                                                <a href="edit_leadership.php?edit=<?php echo $record['lp_id']; ?>">
                                                    <button type="button" rel="tooltip" class="btn btn-success btn-icon btn-sm ">
                                                        ...
                                                        <a href="process/leadership_delete.php?dlt=<?php echo $record['lp_id']; ?>">
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="imageModal<?php echo $record['lp_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="imageModal" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <?php
                                                                    $image_query = "SELECT * FROM leadership_profiles WHERE lp_id = {$record['lp_id']}";
                                                                    $image_result = mysqli_query($conn, $image_query);
                                                                    while ($image_row = mysqli_fetch_assoc($image_result)) {
                                                                        $image_path = $image_row['profile_image'];
                                                                    ?>
                                                                        <form action="process/leadership_imageUpdate.php" method="post" enctype="multipart/form-data">
                                                                            <img src="uploads/staff/<?php echo $image_path; ?>" width="100" height="100">
                                                                            <input type="file" name="newimg" class="form-control">
                                                                            <input type="hidden" name="imgid" value="<?php echo $image_row['lp_id']; ?>" class="form-control">
                                                                            <input type="hidden" name="id" value="<?php echo $record['lp_id']; ?>" class="form-control">
                                                                            <input type="submit" value="update" class="btn btn-info">
                                                                            <!-- <a href="process/album_imageUpdate.php?dlt=<?php echo $image_row['lp_id']; ?>"><button class="btn btn-danger">Delete</button></a> -->
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="process/leadership_process.php" method="post" enctype="multipart/form-data">
