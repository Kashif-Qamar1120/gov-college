    ...
    <section id="about-us"
      ...
      <div class="p-4 about-us-body">
        ...
        <div class="mt-4 text-sm text-justify text">
          ...
          <div class="mt-3 text-sm text-justify text-para2">
            ...
            <main class="container px-4 py-12 mx-auto lg:px-8">
              ...
              <!-- ################# Mission and Impact Section##########3 -->
              <section class="grid grid-cols-1 gap-8 mb-16 md:grid-cols-2 lg:grid-cols-4">
                <div
                  class="p-6 text-center transition duration-500 transform bg-white rounded-lg shadow-lg hover:scale-105 hover:shadow-2xl">
                  <div class="mb-4">
                    <img src="./assets/aboutImg/dart-mission-goal-success-svgrepo-com.svg" alt=""
                ...
                <div
                  ...
                  <div class="mb-4">
                    ...
                    <img src="./assets/aboutImg/wrench-screwdriver-svgrepo-com.svg" alt=""
                      class="w-12 h-12 mx-auto">
                  </div>
                ...
                <div
                  class="p-6 text-center transition duration-500 transform bg-white rounded-lg shadow-lg hover:scale-105 hover:shadow-2xl">
                  <div class="mb-4">
                    <img src="./assets/aboutImg/dollar-coin-on-hand-svgrepo-com.svg" alt="Icon 3"
                      class="w-12 h-12 mx-auto">
                  </div>
                ...
                <div
                  class="p-6 text-center transition duration-500 transform bg-white rounded-lg shadow-lg hover:scale-105 hover:shadow-2xl">
                  <div class="mb-4">
                    <img src="./assets/aboutImg/eye-svgrepo-com.svg" alt="Icon 4"
                      class="w-12 h-12 mx-auto">
                  </div>
              ...
              <!-- ##################### Timeline Section############# -->
              <section class="grid mb-16">
                <h2 class="mb-8 text-2xl font-semibold text-center text-white">Key Milestones</h2>
